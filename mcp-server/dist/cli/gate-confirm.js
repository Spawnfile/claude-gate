...
// src/log.ts
var PREFIX = "[claude-gate]";
function warn(message) {
  console.error(`${PREFIX} WARN ${message}`);
}

// src/active-session.ts
var ActiveSessionSchema = external_exports.object({
...
// src/cli/gate-confirm.ts
var PROTO = "1";
async function runGateConfirm(opts) {
